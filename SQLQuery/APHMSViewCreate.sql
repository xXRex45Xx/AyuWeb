...
alter view Management_Doctor_SearchView
as
select 
	doctorNo as DoctorNumber,
    CONCAT(firstName, ' ', fatherName) as DoctorName,
    phoneNo as PhoneNumber
from Doctor;

alter view Management_LabTechnician_SearchView
as
select
	technicianNo as TechnicianNumber,
    CONCAT(firstName, ' ', fatherName) as TechnicianName,
    phoneNo as PhoneNumber
from LabTechnician;

alter view Management_Reception_SearchView
as
select
